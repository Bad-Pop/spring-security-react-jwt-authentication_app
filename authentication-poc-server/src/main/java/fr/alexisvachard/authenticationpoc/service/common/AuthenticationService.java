...
public class AuthenticationService {
    ...
    public ResponseEntity<?> authenticateUser(LoginRequestDto loginRequest) throws AppException {
        ...
        if(user.isUsingTwoFA()){
            ...
            if(loginRequest.getTwoFACode() > 0){
                if(gAuth.authorize(twoFAUserKey, loginRequest.getTwoFACode())){
                    ...
                    throw new AppException("Invalid 2FA authentication code ! Please try again later...");
                }
            } else {
                throw new AppException("Two-Factor authentication is enable for your account ! Please enter the code generated by your mobile application.");
            }
        } else {
            Authentication authentication = authenticationManager.authenticate(
                    new UsernamePasswordAuthenticationToken(
    ...
    public ResponseEntity<?> registerUser(RegisterRequestDto registerRequest) throws AppException {
        ...
        //TODO SEND EMAIL CINFIRMATION (ASYNC)
